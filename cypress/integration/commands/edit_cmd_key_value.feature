Feature: Key Value can be edited
    ...
    Scenario: The user edits an sms short code
        Given a sms command with parser type Key Value exists with a short code field with a value
        And the user is editing an Key Value parser command
    ...
    Scenario: The user changes the formula of the first short code
        Given a sms command with parser type Key Value exists with a short code fields with a value and a formula
        And the user is editing an Key Value parser command
